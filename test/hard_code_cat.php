<!-- THIS IS A WORST CASE SCENARIO FILE FOR IF WE CANNOT FIGURE OUT HOW TO DYNAMICALLY 
...
<?php 
	...
	$sql = 'SELECT title, price, user, image FROM additem WHERE category="Small Appliances" ORDER BY created_at';
